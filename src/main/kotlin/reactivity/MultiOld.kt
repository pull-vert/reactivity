...
): MultiOld<T> = MultiOld(context, block)

class MultiOld<T> internal constructor(open val context: CoroutineContext,
...
//    }
    ...
    // static constructors
    companion object {
        fun fromRange(start: Int, count: Int, context: CoroutineContext = EmptyCoroutineContext): MultiOld<Int> {
            return MultiOld(context) {
     ...
     */
    fun delay(context: CoroutineContext = EmptyCoroutineContext, delay: Long) : MultiOld<T> {
        return MultiOld(context) {
