...
package kotlinx.coroutines.experimental.common.channels

import kotlinx.coroutines.experimental.common.CompletionHandler
...
public abstract class AbstractSendChannel<E> : SendChannel<E> {
    ...
    private class SendSelect<E, R>(
            ...
            val block: suspend (SendChannel<E>) -> R
...
public abstract class AbstractChannel<E> : AbstractSendChannel<E>(), Channel<E> {
    ...
    private fun removeReceiveOnCancel(cont: CancellableContinuation<*>, receive: Receive<*>) {
        cont.invokeOnCompletion (false, object : CompletionHandler {
    ...
    private class ReceiveElement<in E>(
        val cont: CancellableContinuation<E?>,
        val nullOnClose: Boolean
    ) : Receive<E>() {
...
/** @suppress **This is unstable API and it is subject to change.** */
val SELECT_STARTED: Any = Symbol("SELECT_STARTED")

/** @suppress **This is unstable API and it is subject to change.** */
val NULL_VALUE: Any = Symbol("NULL_VALUE")

/** @suppress **This is unstable API and it is subject to change.** */
val CLOSE_RESUMED: Any = Symbol("CLOSE_RESUMED")

/** @suppress **This is unstable API and it is subject to change.** */
val SEND_RESUMED = Symbol("SEND_RESUMED")
