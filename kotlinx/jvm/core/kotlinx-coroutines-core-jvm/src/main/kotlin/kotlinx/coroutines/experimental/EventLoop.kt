...
import kotlinx.coroutines.experimental.common.expect.TimeUnit
...
abstract class EventLoopBase: CoroutineDispatcher(), Delay, EventLoop {
    ...
    internal abstract inner class DelayedTask(
        ...
        var state = DELAYED
        @JvmField val nanoTime: Long = timeSource.nanoTime() + timeUnit.delegate.toNanos(time)
