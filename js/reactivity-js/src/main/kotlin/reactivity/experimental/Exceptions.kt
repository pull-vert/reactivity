...
interface Exceptions {
    ...
    companion object {
        ...
        fun bubble(t: Throwable): RuntimeException {
            throwIfFatal(t)
            return BubblingException(t.message!!)
        }
        ...
        fun throwIfFatal(t: Throwable) {
            if (t is BubblingException) throw t
        }
 ...
 */
internal open class ReactiveException(message: String) : RuntimeException(message)

internal open class BubblingException(message: String) : ReactiveException(message)

internal class ErrorCallbackNotImplemented(cause: Throwable) : UnsupportedOperationException(cause.message)
